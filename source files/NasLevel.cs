...
namespace NotAwesomeSurvival {
    ...
    public partial class NasLevel {
        ...
        public void FastSetBlock(int x, int y, int z, BlockID serverBlockID, bool disturbDiagonals = false) {
            lvl.Blockchange((ushort)x, (ushort)y, (ushort)z, serverBlockID);
            DisturbBlocks(x, y, z, disturbDiagonals);
        }
        ...
        public void DisturbBlock(int x, int y, int z, int changeX = 0, int changeY = 0, int changeZ = 0) {
            ...
            { return; }
        	BlockID block = lvl.FastGetBlock((ushort)(x + changeX), (ushort)(y + changeY), (ushort)(z + changeZ));
